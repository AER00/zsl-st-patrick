const LANG_PL = {
    ...
    "render-text-p-2": "Święto celebrujące kulturę Irlandzką, najbardziej powszechne w&nbsp;Stanach Zjednoczonych, Kanadzie, Australii i, oczywiście, w&nbsp;rlandii. Do sposob&oacute;w świętowania należy branie udziału w&nbsp;aradach, noszenie zielonych ubrań udekorowanych symbolem <strong>tr&oacute;jlistnej koniczyny</strong> (narodowej rośliny Irlandii), jak i&nbsp;icie irlandzkiego piwa czy whiskey.",
    "render-text-p-3": "Pierwsza odnotowana parada z okazji dnia Św. Patryka odbyła się w&nbsp;<strong>1601</strong> roku w&nbsp;hiszpańskiej kolonii na terenie dzisiejszego <strong>St. Augustine na Florydzie</strong>. Jednakże tradycja przyjęła się dopiero niecałe dwa wieki p&oacute;źniej, od roku <strong>1772</strong>, począwszy od <strong>Bostonu i&nbsp;owego Jorku</strong>, gdzie mieszkała spora ilość irlandzkich imigrant&oacute;w. Ta liczba tylko wzrosła w&nbsp;strong>1845</strong> roku, kiedy <strong>Wielki Gł&oacute;d w&nbsp;landii</strong> zmusił ponad milion biednych, niewykształconych irlandczyk&oacute;w do emigracji do Stan&oacute;w Zjednoczonych aby uniknąć śmierci głodowej.\n",
    "render-text-p-4": "Katoliccy irlandczycy byli mniejszością religijną w&nbsp;USA, gdzie dominował protestantyzm, co&nbsp;rowadziło do ich <strong>dyskryminacji</strong>. Często utrudniało im to znalezienie jakiejkolwiek pracy. Kiedy wychodzili na ulice świętując dzień Św. Patryka, komiksy w&nbsp;gazetach ukazywały ich jako skłonnych do przemocy pijak&oacute;w.\n",
    "render-text-p-5": "Jednakże w&nbsp;następnych latach, irlandzy imigranci w&nbsp;USA uświadomili sobie, że ich duże i wciąż rosnące liczby obdarzyły ich niewykorzystaną siłą polityczną. Zaczęłi się organizować, formując blok znany jako <em><strong>\"green machine\"</strong></em> (<em>\"zielona maszyna\"</em>), i&nbsp;iedługo parady w&nbsp;niu Świętego Patryka stały się symbolem ich siły i&nbsp;ultury, a uczestnictwo w&nbsp;ich stało się niemal obowiązkowe dla wielu kandydat&oacute;w&nbsp;olitycznych.\n",
