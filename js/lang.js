const LANG_PL = {
    ...
    "render-text-header-2": "Dzień Świętego Patryka",
    "render-text-p-1": "Był Irlandzkim biskupem, jak i <strong>świętym patronem</strong> kraju. Data jego święta to 17 marca, <strong>rocznica jego śmierci</strong>, do kt&oacute;rej doszło w V wieku. Najbardziej znana legenda o Św. Patryku opowiada jak wyjaśnił Świętą Tr&oacute;jcę (Ojca, Syna i Ducha Świętego) przy pomocy trzech liści irlandzkiej koniczyny.",
    ...
    "render-text-p-5": "Jednakże w następnych latach, irlandzy imigranci w USA uświadomili sobie, że ich duże i wciąż rosnące liczby obdarzyły ich niewykorzystaną siłą polityczną. Zaczęłi się organizować, formując blok znany jako <em><strong>\"green machine\"</strong></em> (<em>\"zielona maszyna\"</em>), i niedługo parady w dniu Świętego Patryka stały się symbolem ich siły i kultury, a uczestnictwo w nich stało się niemal obowiązkowe dla wielu kandydat&oacute;w politycznych.\n",
